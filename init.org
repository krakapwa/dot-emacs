...
Largely inspired by: https://github.com/larstvei/dot-emacs/

** Installation
#+begin_src shell :tangle no
cd ~
git clone https://github.com/lejeunel/dot-emacs.git .emacs.d

#+end_src

This config relies on the elpa-mirror:
https://raw.githubusercontent.com/lejeunel/myelpa/master/

If it is not accessible, emacs will download packages from official mirrors.
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
'(dired-directory ((t (:foreground "dodger blue"))))
'(dired-symlink ((t (:foreground "cyan"))))
'(helm-ff-file ((t (:foreground "white"))))
'(helm-ff-symlink ((t (:foreground "cyan"))))
'(helm-buffer-directory ((t (:foreground "dodger blue"))))
